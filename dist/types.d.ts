...
export type ApiAiRating = {
    ...
    jobs?: {
        jobs: ApiBioSectionListItem[];
        sources?: unknown[];
    };
    education?: {
        educations: ApiBioSectionListItem[];
        sources?: unknown[];
    };
    accomplishments?: {
        accomplishments: ApiBioSectionListItem[];
        sources?: unknown[];
    };
    controversies?: {
        controversies: ApiBioSectionListItem[];
        sources?: unknown[];
    };
    bestQualities?: {
        qualities: ApiBioSectionListItem[];
        sources?: unknown[];
    };
    netWorth?: {
        netWorth: ApiBioSectionListItem[];
        sources?: unknown[];
    };
    worldview?: {
        politics?: string;
